...
export class EventService{
    ...
    /*
        An Injectable service marks a class as Injectable meaning it is invoked by whichever class that needs it throught dependancy injection.
        Whichever service consumes other modules in its constructor, it MUST be declared as Injectable.
        Every Injectable service must be listed in app.module.ts in the providers: [] so that Angulars injector is aware of this.
     */
...
const event1 = [{
        ...
        onlineUrl: 'http://www.angularconnect.nl.eu/webinar',
        sessions: [
            {
                id: 1,
    ...
    },
    {
        ...
        onlineUrl: 'http://www.ng-vegas.us/webinar',
        sessions: [
            {
                id: 1,
